...
export const NewPost = () => {
    ...
    const formSubmitHandle = async () => {
        ...
        if (user) {
            ...
            fromData.append('description', document.getElementsByName("post_description")[0].value);
            try {
                const { data } = await axios.post(api.newPost, fromData, {
                    headers: {
    ...
    return (
        <>
            ...
            <Modal
                ...
                centered
                dialogClassName="new-post-modal"
            >
                ...
                <Modal.Body>
                    <div className="row">
                        <textarea name="post_description" class="form-control" placeholder="Enter post description here"></textarea>
                    </div>
                    <div className="row">
                ...
                <Modal.Footer>
                    <button class="btn" onClick={formSubmitHandle}>Post</button>
                </Modal.Footer>
            </Modal>
        </>
    )
