...
export const Comments = ({ comments, postId, loadPost }) => {
    ...
    return (
        <>
            ...
            <div className="messageSender postComment">
                <div className="messageSender__top comment-input-wrapper">
                    <form>
                        <input className="messageSender__input" name="comment" placeholder="Post your comment" type="text" />
                        {/* <button className="sendCommentButton">GO</button> */}
                        <img onClick={sendComment} className="cursor_pointer" src={process.env.REACT_APP_PUBLIC_FOLDER + 'send.png'} />
                    </form>
                </div>
            </div>
