...
export const UsersList = ({ users, emptyMessage, showFilter }) => {
            ...
            <div className="post">
                ...
                }
                {
                    ...
                    users.filter(user => {
                        ...
                        if (user.username.includes(filterValue) || user.fullname.includes(filterValue)) {
                            return true
                        }
                    }).map((user, index) => {
                        return (
